                ...
                if($numberOfManga>($NumberPerPage*($PageNumber-1)) && $numberOfManga<=($NumberPerPage*$PageNumber)){?>
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="d-flex justify-content-center br-word">
                            <a class="text-c" href="<?=Yii::$app->request->baseUrl.'/'.'manga/'.$Manga->IdManga?>">
                                ...
                                <img src="<?= Yii::$app->urlManagerBackend->baseUrl.'/img/default/manga_alternative.jpg'?>" height="200" width="150">
                                <?php } ?>
                                <p class="text-color-2 br-word w-150p"> <?=$Manga->Title?> </p>
                            </a>
                        </div>
                    </div>
    ...
    <div class="col-12">
        <ul class="pagination justify-content-end mb-0">
            <li class="page-item <?=($PageNumber == 1)? 'disabled':''?>">
                <a class="page-link bg-color-3 border-0 <?=($PageNumber == 1)? 'text-color-1':'text-color-2'?>" 
                    href="<?=($PageNumber == 1) ? '':$Link.($PageNumber-1)?>">Previous</a>
            </li>
            <li class="page-item <?=($PageNumber == 1)? 'active disabled':''?>">
                <a class="page-link border-0 <?=($PageNumber == 1)? 'bg-color-2 text-color-1':'bg-color-3 text-color-2'?>" 
            ...
            <li class="page-item <?=($PageNumber == 2 || ($PageNumber != 1 && $PageNumber != $NumOfPages))? 'active disabled':''?>">
                <a class="page-link border-0 <?=($PageNumber == 2 || ($PageNumber != 1 && $PageNumber != $NumOfPages))? 'bg-color-2 text-color-1':'bg-color-3 text-color-2'?>" 
            ...
            <li class="page-item <?=($PageNumber == $NumOfPages)? 'active disabled':''?>">
                <a class="page-link border-0 <?=($PageNumber == $NumOfPages)? 'bg-color-2 text-color-1':'bg-color-3 text-color-2'?>" 
            ...
            <li class="page-item <?=($PageNumber == $NumOfPages)? 'disabled':''?>">
                <a class="page-link bg-color-3 border-0 <?=($PageNumber == $NumOfPages)? 'text-color-1':'text-color-2'?>" 
        ...
        <ul class="pagination justify-content-end mb-0">
            ...
            <?php if ($PageNumber == 1) { ?>
            <li class="page-item disabled"><a class="page-link bg-color-3 text-color-1 border-0" href="#">Previous</a></li>
            <?php if ($NumOfPages > 3) { ?>
            <li class="page-item active disabled"><a class="page-link bg-color-2 text-color-1 border-0" href="#"><?=$PageNumber?></a></li>
            <li class="page-item"><a class="page-link bg-color-3 text-color-2 border-0" 
            ...
            <li class="page-item active disabled"><a class="page-link bg-color-2 text-color-1 border-0" href="#"><?=$Pag?></a></li>
            <?php }else{ ?>
            <li class="page-item"><a class="page-link bg-color-3 text-color-2 border-0" 
            ...
            <li class="page-item active disabled"><a class="page-link bg-color-2 text-color-1 border-0" href="#"><?=$PageNumber?></a></li>
            <?php } ?>
            <li class="page-item disabled"><a class="page-link bg-color-3 text-color-1 border-0" href="#">Next</a></li>
            <?php }else{ ?>
            <li class="page-item"><a class="page-link bg-color-3 text-color-2 border-0" 
